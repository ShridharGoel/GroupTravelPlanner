                ...
                .withListener(new MultiplePermissionsListener() {
                    ...
                    public void onPermissionsChecked(MultiplePermissionsReport report) {
                        if (report.isAnyPermissionPermanentlyDenied()) {
                            Toasty.error(Login.this, "You have denied some permissions permanently, if the app force close try granting permission from settings.", Toast.LENGTH_LONG,true).show();
                        }
                    }
                ...
                public void onComplete(@NonNull final Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                                    ...
                                    mFirestore.collection("Users").document(current_id).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                        ...
                                        public void onSuccess(DocumentSnapshot documentSnapshot) {
                                            ...
                                            mFirestore.collection("Users")
                                                ...
                                                public void onFailure(@NonNull Exception e) {
                                                    mDialog.dismiss();
                                                    Toasty.error(Login.this, "Error: " + e.getMessage(), Toasty.LENGTH_SHORT,true).show();
                                                }
                                            });
                        ...
                        if (task.getException().getMessage().contains("The password is invalid")) {
                            Toasty.error(Login.this, "Error: The password you have entered is invalid.", Toasty.LENGTH_SHORT,true).show();
                            mDialog.dismiss();
                        } else if (task.getException().getMessage().contains("There is no user record")) {
                            Toasty.error(Login.this, "Error: Invalid user, Please register using the button below.", Toasty.LENGTH_SHORT,true).show();
                            mDialog.dismiss();
                        } else {
        ...
        if(TextUtils.isEmpty(email.getText().toString())) {
            ...
            FirebaseAuth.getInstance().sendPasswordResetEmail(email.getText().toString())
                    .addOnSuccessListener(aVoid -> {
                        mDialog.dismiss();
                        Toasty.success(Login.this, "Reset password mail sent", Toasty.LENGTH_SHORT,true).show();
                    })
                    .addOnFailureListener(e -> {
                        mDialog.dismiss();
                        Toasty.error(Login.this, "Error sending mail : "+e.getLocalizedMessage(), Toasty.LENGTH_SHORT,true).show();
                    });
        }
